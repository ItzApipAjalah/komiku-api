...
/**
 * Service for handling hot manga operations
 */
const hotService = {
    /**
     * Get hot manga by page
     * @param {number} page - Page number
     * @returns {Promise<Object>} - Hot manga data with pagination info
     */
    getHotManga: async (page = 1) => {
        try {
            // Validate page
            if (page < 1) {
                page = 1;
            ...
            // Construct the API URL for hot manga
            const apiUrl = `https://api.komiku.org/other/hot/page/${page}/`;

            // Fetch the hot manga page
            ...
            throw new Error(`Failed to fetch hot manga: ${error.message}`);
        }
    }
};
